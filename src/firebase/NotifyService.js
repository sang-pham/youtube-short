...
export default class NotifyService {
  ...
  localNotify(
    userSend = 'Trung Vu',
    message = 'Hello! hehe viết dài để test tí ',
    time = '3 min ago',
    soundName,
  ) {
    this.lastId++;
    PushNotification.localNotification({
      ...
      bigText: `${userSend}: ${message}`, // (optional) default: "message" prop
      ...
      message: `${userSend} send you a message`, // (required)
